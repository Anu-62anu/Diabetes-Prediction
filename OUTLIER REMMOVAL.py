...
# Remove outliers
clean_df = df[(z_scores < threshold).all(axis=1)]

# Features and target variable after removing outliers
X = clean_df.drop('Outcome', axis=1)  # Assuming the target variable is named 'Outcome'
y = clean_df['Outcome']
